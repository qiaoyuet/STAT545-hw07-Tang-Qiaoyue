...
![*Fig. 4* life expectancies vs year in Asia](lifeExp_vs_year_in_Asia.png)
![*Fig. 5* life expectancies vs year in Africa](lifeExp_vs_year_in_Africa.png)

![*Fig. 6* life expectancies vs year in Europe](lifeExp_vs_year_in_Europe.png)

![*Fig. 7* life expectancies vs year in Oceania](lifeExp_vs_year_in_Oceania.png)

![*Fig. 8* life expectancies vs year in Americas](lifeExp_vs_year_in_Americas.png)